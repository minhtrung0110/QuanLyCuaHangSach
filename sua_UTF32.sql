...
CREATE TABLE `chitietphieunhap` (
  ...
  `MaSach` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `SoLuong` int(20) NOT NULL,
  `ThanhTien` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_unicode_ci;
...
INSERT INTO `nhanvien` (`MaNV`, `Ho`, `Ten`, `SDT`, `Luong`) VALUES
('MT', 'Nguyễn Đức Minh', 'Trung', '0707624367', 10000000),
('PK', 'Phạm Trần', 'Khôi', '0113114115', 10000000),
('TT', 'Trần Thanh', 'Tùng', '0988364523', 10000000),
('VV', 'Nguyễn Trần Văn', 'Vũ', '0903368547', 10000000);
...
CREATE TABLE `sach` (
  `MaSach` varchar(5) COLLATE utf32_unicode_ci NOT NULL,
  `MaNXB` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `MaTG` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `MaTL` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `TenSach` varchar(50) COLLATE utf32_unicode_ci NOT NULL,
...
('KD01', 'GD', 'J.K.R', 'CT', 'Miḿn Nam', 2000, 5000, 45000, '');
